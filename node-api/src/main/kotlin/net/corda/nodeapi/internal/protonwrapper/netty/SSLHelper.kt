...
internal fun initialiseTrustStoreAndEnableCrlChecking(trustStore: KeyStore): ManagerFactoryParameters {
    ...
    revocationChecker.options = EnumSet.of(
            ...
            // TODO Currently this is enabled but should be disabled once CRL infrastructure is fully operational.
